...
import 'package:hadeer/Instructor/SER3I.dart';

class SystemErrorReportPageI2 extends StatelessWidget {
  const SystemErrorReportPageI2({super.key});
                      ...
                      GestureDetector(
                        onTap: () {
                          // هنا تضع الكود للانتقال لصفحة النجاح مثلاً
                           Navigator.push(context, MaterialPageRoute(builder: (context) => SuccessSendReportPageI()));
                        },
                        child: Container(
                          width: 225,
                          height: 50,
