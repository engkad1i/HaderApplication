...
import 'package:hadeer/Instructor/SRE2I.dart';
import 'package:hadeer/Instructor/Dashboard_i.dart';
class SystemReportsPageI extends StatelessWidget {
  const SystemReportsPageI ({super.key});
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const SystemErrorReportPageI2()));
                        },
                        child: Container(
                          width: 225,
                          height: 50,
