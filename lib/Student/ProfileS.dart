...
class _ProfileScreenState extends State<ProfileS> {
  ...
  final TextEditingController _firstNameController = TextEditingController(text: "Sara");
  final TextEditingController _lastNameController = TextEditingController(text: "Alanzi");
  final TextEditingController _emailController = TextEditingController(text: "");
  final TextEditingController _uniNameController = TextEditingController(text: "");
  final TextEditingController _uniIController = TextEditingController(text: "");
          ...
          children: [
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () {
                  // استخدام rootNavigator للتأكد من الرجوع للخلف بنجاح
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 40,
                    color: Colors.white,
                    shadows: [Shadow(offset: Offset(0, 4), blurRadius: 4, color: Colors.black26)],
                  ),
                ),
              ),
            ),
            ...
            _buildTextField(_uniIController, 88, 564, width: 265, enabled: false),

            _buildLabel("Password :", 95, 608),
            _buildTextField(_passwordController, 88, 635, width: 265, isPassword: true),
  ...
  Widget _buildTextField(TextEditingController controller, double left, double top, {double width = 265, bool isPassword = false, bool enabled = false,}) {
    return Positioned(
      left: left,
      top: top,
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Image.asset('assets/9.png', width: 16, height: 16), // أيقونة التعديل
          ],
        ),
      ),
    );
