...
class SuccessSendReportPageS extends StatelessWidget {
  const SuccessSendReportPageS({super.key});
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Dashboard_s()));
